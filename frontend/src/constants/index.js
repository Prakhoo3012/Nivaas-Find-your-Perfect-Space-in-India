// ─── Cities ────────────────────────────────────────────
// Sirf dropdown options ke liye — icons/counts ab listings se dynamically aate hain
export const CITIES = [
  { name: "Jaipur" },
  { name: "Delhi" },
  { name: "Mumbai" },
...
// City ke naam se icon map — ek jagah define, har jagah use
...
export const MOCK_LISTINGS = [
  {
    ...
    roomInfo: { availableRooms: 1, bathrooms: 1, areaSqFt: 380 },
    isNew: true,
  },
  {
    _id: "2",
  ...
  },
  {
    ...
    roomInfo: { availableRooms: 1, bathrooms: 1, areaSqFt: 220 },
    isNew: true,
  },
  {
    _id: "7",
  ...
  {
    _id: "8",
    title: "Furnished Room in HSR Layout",
    propertyType: "room",
    location: { city: "Bangalore", state: "Karnataka" },
...
export const INIT_REQUESTS = [
  {
    _id: "r1",
    tenant: { fullName: "Priya Sharma" },
    property: { title: "Sunlit Studio in Malviya Nagar" },
    checkIn: "2025-08-01",
    checkOut: "2025-08-31",
    guests: { adults: 1 },
    bookingType: "per_month",
    priceBreakdown: { totalAmount: 12000 },
    status: "pending",
  },
  {
    _id: "r2",
    tenant: { fullName: "Rahul Mehta" },
    property: { title: "Heritage Haveli Suite" },
    checkIn: "2025-07-15",
    checkOut: "2025-07-18",
    guests: { adults: 2 },
    bookingType: "per_night",
    priceBreakdown: { totalAmount: 13500 },
    status: "pending",
  },
  {
    _id: "r3",
    tenant: { fullName: "Ananya Krishnamurthy" },
    property: { title: "Sunlit Studio in Malviya Nagar" },
    checkIn: "2025-07-01",
    checkOut: "2025-07-31",
    guests: { adults: 1 },
  ...
  {
    _id: "r4",
    tenant: { fullName: "Karan Singh" },
    property: { title: "Heritage Haveli Suite" },
    checkIn: "2025-06-10",
    checkOut: "2025-06-12",
    guests: { adults: 2 },
    bookingType: "per_night",
    priceBreakdown: { totalAmount: 9000 },
    status: "completed",
  },
];
